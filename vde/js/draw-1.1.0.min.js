...
var setSavedMouse=function([x,y]){mouse[0]=x;mouse[1]=y;}
var getZoomedXY=function([x,y]){return{x:x+(x-400)*(getZoom()-1),y:y+(y-200)*(getZoom()-1)};};var getZoomedX=function(x){return x+(x-400)*(getZoom()-1);}
